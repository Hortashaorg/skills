...
export interface EcosystemTagFilterProps {
	selectedTagSlugs: string[];
	onTagsChange: (slugs: string[]) => void;
}

export const EcosystemTagFilter = (props: EcosystemTagFilterProps) => {
	const [tags] = useQuery(queries.tags.listWithEcosystemCounts);
